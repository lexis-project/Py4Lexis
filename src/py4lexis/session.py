...
class LexisSession(object):
    ...
    def __init__(self, 
                 ...
                 log_file: str="./lexis_logs.log") -> None:
        """
            ...
            supress_print: bool, optional
                If False, messages will be printed.
            ...
            handle_request_status(self, 
                                  ...
                                  log_msg: str, 
                                  to_json: bool = True,
                                  suppress_print: bool=True) -> tuple[dict | bytes, bool, bool]
