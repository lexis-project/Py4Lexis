...
class DirectoryTree(object):
    ...
    def __init__(self, print_name: str, parent: DirectoryTree | None, is_last: bool) -> None:
    ...
    def make_tree(cls, tree_content: TreeDirectoryObject | TreeFileObject, parent: Optional[object | None]=None, is_last: Optional[bool]=False) -> Generator[DirectoryTree, None, None]:
        ...
        displayable_root: DirectoryTree = cls(tree_content.name, parent, is_last)
        ...
        for item in children:
            ...
            if item.is_dir():
                ...
                yield cls(item.name, displayable_root, is_last)
            count += 1
    ...
    def to_string(self) -> str:
        ...
        parts: list[str] = ["{!s} {!s}".format(_filename_prefix, self.print_name)]
